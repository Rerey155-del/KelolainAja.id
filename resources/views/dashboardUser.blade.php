            ...
            <div class="container-fluid">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div
                        ...
                        <div
                            class="gradient-bg w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 bg-gradient-to-r from-red-400 to-red-600">
                    ...
                    <div
                        class="glass-card hover-scale rounded-xl p-6 text-center bg-white shadow-lg transition-transform duration-300 hover:shadow-xl">
                        <div
                            class="gradient-bg w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 bg-gradient-to-r from-green-400 to-green-600">
