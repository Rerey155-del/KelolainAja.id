        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #FF4655;">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="/admin/videos" data-target="#collapseTwo" aria-expanded="true"
                 ...
                 <a class="nav-link collapsed" href="/admin/contantPiilar" data-target="#collapseTwo" aria-expanded="true"
                    aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Contant Pillar</span>
                </a>
                 <a class="nav-link collapsed" href="/admin/contantCalendar" data-target="#collapseTwo" aria-expanded="true"
                    aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
